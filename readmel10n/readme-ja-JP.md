...
> 🚨 **「天才」Fork ユーザー諸君へ**
> 
> 最近、2種類の頭の悪い行動が観測されている：
> 
> **タイプA**：Fork 関係を切って、アップストリームに同期しない  
> 古いコードで誤検出を量産し、自分は賢いと思い込んでいる。issue が爆発しても泣きつくな。
> 
> **タイプB**：プライベートリポジトリなのに `REPO_NAME` を変更しない  
> スキャン結果が全部こっちのリポジトリに送られてきて、迷惑通知の嵐。そこまで頭いいなら、ついでにコールバック先も自分のリポジトリに変えたらどうだ？
> 
> **両者へ：お前らの行動はアップストリームへの妨害行為だ。直すか、リポジトリを消せ。**
> 
> お前らの愚かさに技術サポートを提供する気は一切ない。  
> — 原作者より、お世話係ではありません QwQ
